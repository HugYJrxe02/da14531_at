...
static int app_uart_timer_handler(ke_msg_id_t const msgid,
                                   void const *param,
                                   ke_task_id_t const dest_id,
                                   ke_task_id_t const src_id)
{
...
static const struct ke_msg_handler app_custs1_process_handlers[] =
{
    ...
    {CUSTS1_DISABLE_IND,                   (ke_msg_func_t)app_custs1_disable_ind_handler},
		{APP_UART_TIMER,                       (ke_msg_func_t)app_uart_timer_handler},  //chen 2021-7-8
};
#endif
